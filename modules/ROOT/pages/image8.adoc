...
[NOTE]
====
Three words from Article 14--*"wurden zwei drittheil"*--were struck out and above them was written:
*"wird die Majorität der"*. The original read:
...
zu einem für die Gemeinde gültigen Beschluß *wurden zwei drittheil* +
